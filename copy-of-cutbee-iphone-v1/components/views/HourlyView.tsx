import React, { useState, useMemo } from 'react';
    ...
    export default function HourlyView({ allData }: HourlyViewProps) {
      ...
      return (
        <div className="clean-card p-6 md:p-10 shadow-sm animate-fade">
            ...
            <div className="flex flex-col xl:flex-row justify-between items-start mb-10 gap-6">
                <div className="space-y-4 w-full xl:w-auto">
                    ...
                    <div className="flex flex-wrap gap-2 w-full">
                         {['all', '3', '6', '12'].map((r) => (
                            <button key={r} onClick={() => setRange(r as any)} className={`text-xs font-bold px-3 py-1.5 rounded-full transition flex-1 xl:flex-none ${range === r ? 'bg-[#244c5a] text-white' : 'bg-slate-200 text-slate-600 hover:bg-white hover:text-[#244c5a]'}`}>

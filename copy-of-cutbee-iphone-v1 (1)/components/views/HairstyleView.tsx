    ...
    export default function HairstyleView({ allData }: HairstyleViewProps) {
      ...
      return (
        <div className="space-y-10 animate-fade">
            <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4 bg-slate-50 p-3 rounded-xl border border-slate-100">
                ...
                <div className="flex flex-wrap gap-2 w-full xl:w-auto">
                    {['all', '3', '6', '12'].map((r) => (
                        <button 
                            ...
                            className={`text-xs font-bold px-3 py-1.5 rounded-full transition flex-1 xl:flex-none ${range === r ? 'bg-[#244c5a] text-white' : 'bg-slate-200 text-slate-600 hover:bg-white hover:text-[#244c5a]'}`}
                        >
            ...
            <div className="clean-card p-6 md:p-8 h-[400px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="clean-card p-6 md:p-10 h-[400px] md:h-[500px]">

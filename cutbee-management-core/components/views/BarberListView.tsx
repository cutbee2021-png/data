import React, { useState, useMemo } from 'react';
    ...
    export default function BarberListView({ metrics, onSelectBarber }: BarberListViewProps) {
      ...
      return (
        <div className="clean-card p-8 shadow-sm animate-fade">
            <div className="flex justify-between items-center mb-8">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <select 
                        ...
                        className="bg-slate-50 border border-slate-100 rounded-lg px-3 py-2 text-xs font-bold text-slate-600 outline-none cursor-pointer hover:bg-slate-100 transition"
                    >
